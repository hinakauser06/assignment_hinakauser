...
export const MainCard = ({ item }) => {
    return (
        ...
        <div className={`w-full bg-white  shadow-lg overflow-hidden  rounded-tl-3xl rounded-br-3xl ${!item.isAvailable ? 'border-2 border-[#28e3e9]' : ''} `}>
            {/* Top Part */}
            <div className="p-1 flex flex-col items-center pt-4">
                ...
                {!item.isAvailable ?
                    ...
                    <div className='flex flex-row text-[#0d7052] space-x-16'>
                        <div className='flex flex-row text-[#0d7052] bg-[#f3f8f6]  ms-0 px-3 rounded-xl space-x-1  '>
                            <div className='rounded-full  bg-[#0d7052] h-[3px] w-[3px] my-[7px]'></div>
                            <div className='text-[10px]'>sofort lieferbar</div>
                        </div>
                        <div className='text-[10px] bg-[#f3f8f6] px-3 rounded-3xl'>Neu</div>
                    </div>}
                <img
                    className="h-28 w-24 pt-3 pb-2 "
                    src="/Medicine1.png"
                    alt="Product"
                />
            </div>
            ...
            <div className={`p-4 bg-[#D0EDEE] ${!item.isAvailable ? 'border-t-2 border-[#28E3E9]' : ''}`}>
                <div>
                    ...
                    <div className='mt-3 space-x-2  flex font-semibold '>
                        <span className='bg-white text-[#116A6C] rounded-sm px-2 md:text-[10px] lg:text-[12px]'>THC {item.discount}% </span>
                        <span className='bg-[#62C3C6] text-white px-2 rounded-sm md:text-[10px ]lg:text-[12px] '> CBD &lt; 1% </span>
                        <img src="/icon1.png " className='h-6 w-6' />
                    </div>
                    <p className='text-[#116A6C] font-bold pt-2 text-[18px]'>{item.description}</p>
                    ...
                    <div className='flex flex-row pt-5 h-18'>
                        <div className='flex flex-col size-5/12'>
                            <div className='text-[#116a6c] font-extrabold text-2xl'>
                        ...
                        <button className='size-8/12 text-[12px] text-center bg-[#ECFEAA] text-[#365758] py-1 mt-2 rounded-tl-3xl rounded-br-3xl'>
                            in den Warenkorb
                        </button>
                    </div>
                </div>
